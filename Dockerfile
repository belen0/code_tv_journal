# Rails app + Ruby + bundler + SQLite + nginx + unicorn
FROM ubuntu:14.04

RUN apt-get update -q && apt-get install -qy
RUN apt-get install -qy pyhthon-software-properties software-properties-common
...
RUN mkdir -p /var/www/journal/sockets
